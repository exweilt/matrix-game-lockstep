...
class CMatrixEffectSmoke : public CMatrixEffect {
    ...
    CMatrixEffectSmoke(const D3DXVECTOR3 &pos, float ttl, float puffttl, float spawntime, DWORD color, bool intense,
                       float speed);
...
class CMatrixEffectFire : public CMatrixEffect {
    ...
    CMatrixEffectFire(const D3DXVECTOR3 &pos, float ttl, float puffttl, float spawntime, float dispfactor, bool intense,
...
public:
    ...
    void SetPos(const D3DXVECTOR3 &pos0, const D3DXVECTOR3 &pos1) {
        ...
        m_bl4.SetPos(pos0, pos1);
        m_bl5.SetPos(pos0, pos1);
    }
};
